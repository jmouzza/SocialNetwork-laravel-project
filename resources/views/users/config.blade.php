                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('config.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="@error('surname'){{old('surname')}}@else {{Auth::user()->surname}}@enderror" required autocomplete="surname" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nick" type="text" class="form-control @error('nick') is-invalid @enderror" name="nick" value="@error('nick'){{old('nick')}}@else {{Auth::user()->nick}}@enderror" required autocomplete="nick" autofocus>
